...
// The "do not edit" notice is for whoever opens this file, not for the person reading the policy.
// It used to render as a footer line on the page itself, where it was noise to every visitor and
// meaningless to a store reviewer — an HTML comment reaches the right audience and nobody else.
const html = `<!doctype html>
<!--
  Generated from docs/PRIVACY.md — do not edit this file.
  Change the markdown, then run: npm run privacy:page
-->
<html lang="zh-CN">
<head>
<meta charset="utf-8">
